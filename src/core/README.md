...
| `sampling/` | 피부색 샘플링 (볼 8지점, 반경은 얼굴 너비 비례, 밝기 절사 평균) — 이마는 앞머리 오염 때문에 제외한다 ([ADR-004](../../docs/adr/004-relative-skin-distribution-judgment.md)) |
| `color/` | sRGB→CIELAB 변환과 파생 지표(채도·색상각·ITA), 눈 흰자를 기준자로 쓰는 조명 보정 두 축 — **색**([ADR-006](../../docs/adr/006-white-balance-by-eye-sclera.md))과 **밝기**(`exposure.ts`) |
